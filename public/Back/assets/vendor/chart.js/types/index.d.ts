...
export interface BarControllerDatasetOptions
  ...
  /**
   * Percent (0-1) of the available width each bar should be within the categorie width. 1.0 will take the whole categorie width and put the bars right next to each other.
   * @default 0.9
   */
  barPercentage: number;
  /**
   * Percent (0-1) of the available width each categorie should be within the sample width.
   * @default 0.8
   */
