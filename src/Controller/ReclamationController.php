...
class ReclamationController extends AbstractController
{
    ...
    public function statistique(ReclamationRepository $reclamationRepository,UserRepository $userRepository): Response
    {
    ...
    public function adminreclamation(ReclamationRepository $reclamationRepository,UserRepository $userRepository): Response
    {
    ...
    public function new(ValidatorInterface $validator,Request $request, ReclamationRepository $reclamationRepository,UserRepository $userRepository): Response
    {   $user=new User();
        $user=$userRepository->find(1);
