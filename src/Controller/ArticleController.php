...
class ArticleController extends AbstractController
{
    ...
    public function indexfront(Request $request, PaginatorInterface $paginator,UtilisateurRepository $userRep,BasketRepository $basketRep): Response
    {
        ...
        return $this->render('article/indexfront.html.twig', ['listS' => $pagination,'existingArticles' => $existingArticles,'basketItemsCount' => $basketItemsCount,
...
// LES  attributs
    ...
    public function search2(Request $request, \App\Repository\ArticleRepository $repo): Response
    {
        ...
        $artlib = $request->query1->get('artlib');
