...
class LivraisonController extends AbstractController
{
    ...
    #[Route('/new/{idCommand}', name: 'app_livraison_new', methods: ['GET', 'POST'])]
    public function new($idCommand,Request $request, LivraisonRepository $livraisonRepository,CommandsRepository $commandeRepository,LivreurRepository $livreurRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $livraison->setCommande($idCommand);
